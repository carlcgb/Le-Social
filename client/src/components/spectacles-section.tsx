...
export default function SpectaclesSection() {
  ...
  return (
    <section id="spectacles" className="py-20 bg-gradient-to-r from-burgundy-900/30 to-black">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-burgundy-800/30 border border-gold-500/30 rounded-xl p-6 mb-8"
            >
