      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <circle cx="30" cy="40" r="2" fill="#32a5bf" opacity="0.9" />
              <circle cx="50" cy="35" r="2" fill="#32a5bf" opacity="0.9" />
              <circle cx="70" cy="40" r="2" fill="#32a5bf" opacity="0.9" />
            </motion.g>
            
            {/* Gradient definitions */}
            <defs>
              <linearGradient id="goldGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#5BBDD9" />
                <stop offset="50%" stopColor="#32a5bf" />
